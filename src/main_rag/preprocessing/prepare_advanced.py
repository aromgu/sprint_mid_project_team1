...
from src.main_rag.preprocessing.clean_text import (
    HWP_FILE_TYPES,
    PDF_FILE_TYPE,
...
from src.main_rag.preprocessing.table_formats import (
    ...
    *,
    ...
    for record in records:
        ...
        source = SourceDocument(
            source_id=source_id,
            # The parser's integrity contract uses the content-addressed ID.
            # The external eval document_id remains in the manifest and is
            # restored by build_advanced_result for retrieval filtering.
