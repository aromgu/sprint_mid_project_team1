...
def main() -> int:
    ...
    parser.add_argument("--responses", type=Path, default=PROJECT_ROOT / "reports" / "main_advanced" / "answers.jsonl")
    parser.add_argument("--output", type=Path, default=PROJECT_ROOT / "reports" / "main_advanced" / "answer_summary.json")
    ...
    for response in responses:
        ...
        answer_status = response.get("answer_status") or (
            "answered" if response.get("is_answerable") else "unanswerable"
        )
        ...
        details.append({
            ...
            "answerability_correct": predicted_answerable == item.answerable,
