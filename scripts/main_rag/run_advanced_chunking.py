...
from src.main_rag.chunking.advanced_chunking import (
    CORPUS_ID,
...
DEFAULT_PREPROCESSING_DIR = _SETTINGS.path("preprocessing_dir")
DEFAULT_DOCUMENTS_PATH = DEFAULT_PREPROCESSING_DIR / "documents_advanced_v1.jsonl"
DEFAULT_BLOCKS_PATH = DEFAULT_PREPROCESSING_DIR / "blocks_advanced_v1.jsonl"
DEFAULT_OUTPUT_PATH = _SETTINGS.path("chunks")
DEFAULT_REPORT_PATH = _SETTINGS.path("chunking_report")
# These sentinels keep the source overwrite-protection logic, but point at
# impossible workspace-local legacy names instead of another machine's paths.
PROTECTED_V1_OUTPUT_PATH = DEFAULT_OUTPUT_PATH.with_name(".protected_v1_chunks")
PROTECTED_V1_REPORT_PATH = DEFAULT_REPORT_PATH.with_name(".protected_v1_report")
